...
verbos = [
    ...
    {"kanji": "始める", "hiragana": "はじめる", "romaji": "hajimeru", "es": "comenzar", 
    "en": "begin"},
    {"kanji": "ある", "hiragana": "ある", "romaji": "aru", "es": "haber (inanimado)", 
    "en": "exist (inanimate)"},
    {"kanji": "いる", "hiragana": "いる", "romaji": "iru", "es": "haber (animado)", 
    "en": "exist (animate)"},
    ...
    {"kanji": "写真を撮る", "hiragana": "しゃしんをとる", "romaji": "shashin o toru", 
    "es": "tomar una foto", "en": "take a photo"},
    ...
    {"kanji": "吸う", "hiragana": "すう", "romaji": "suu", "es": "fumar/inhalar", 
    "en": "smoke/inhale"},
    ...
    {"kanji": "出かける", "hiragana": "でかける", "romaji": "dekakeru", "es": "salir (para)", 
    "en": "go out"},
    {"kanji": "出す", "hiragana": "だす", "romaji": "dasu", "es": "sacar", "en": "take out"},
    {"kanji": "持つ", "hiragana": "もつ", "romaji": "motsu", "es": "tener", "en": "have/hold"},
    {"kanji": "返す", "hiragana": "かえす", "romaji": "kaesu", "es": "devolver", 
    "en": "return (an item)"},
    {"kanji": "借りる", "hiragana": "かりる", "romaji": "kariru", "es": "tomar prestado", 
    "en": "borrow"},
    ...
    {"kanji": "かかる", "hiragana": "かかる", "romaji": "kakaru", "es": "tardar", 
    "en": "take (time/money)"},
    {"kanji": "急ぐ", "hiragana": "いそぐ", "romaji": "isogu", "es": "apresurarse", "en": "hurry"},
    {"kanji": "引く", "hiragana": "ひく", "romaji": "hiku", "es": "tirar", "en": "pull"},
    {"kanji": "お腹が空く", "hiragana": "おなかがすく", "romaji": "onakagasuku", "es": "tener hambre", 
    "en": "be hungry"},
    {"kanji": "喉が渇く", "hiragana": "のどがかわく", "romaji": "nodokawaku", "es": "tener sed", 
    "en": "be thirsty"},
    {"kanji": "シャワーを浴びる", "hiragana": "しゃわーをあびる", "romaji": "shawaa o abiru", "es": "ducharse", 
    "en": "take a shower"},
    {"kanji": "電話をかける", "hiragana": "でんわをかける", "romaji": "denwa o kakeru", 
    "es": "hacer una llamada", 
    "en": "make a call"},
    {"kanji": "足りる", "hiragana": "たりる", "romaji": "tariru", "es": "ser suficiente", 
    "en": "be enough"},
    {"kanji": "する", "hiragana": "する", "romaji": "suru", "es": "hacer", "en": "do"},
    {"kanji": "勉強する", "hiragana": "べんきょうする", "romaji": "benkyou suru", "es": "estudiar", 
    "en": "study"},
    {"kanji": "食事します", "hiragana": "しょくじします", "romaji": "shokuji shimasu", "es": "comer (formal)",
    "en": "have a meal"},
    {"kanji": "練習する", "hiragana": "れんしゅうする", "romaji": "renshuu suru", "es": "practicar", 
    "en": "practice"},
    {"kanji": "復習する", "hiragana": "ふくしゅうする", "romaji": "fukushuu suru", "es": "repasar", 
    "en": "review"},
    {"kanji": "結婚する", "hiragana": "けっこんする", "romaji": "kekkon suru", "es": "casarse", 
    "en": "marry"},
    {"kanji": "掃除する", "hiragana": "そうじする", "romaji": "souji suru", "es": "limpiar", 
    "en": "clean"},
    {"kanji": "務める", "hiragana": "つとめる", "romaji": "tsutomeru", "es": "trabajar (formal)", 
    "en": "work (formal)"},
    {"kanji": "着る", "hiragana": "きる", "romaji": "kiru", "es": "ponerse", "en": "put on"},
    {"kanji": "履く", "hiragana": "はく", "romaji": "haku", "es": "ponerse (calzado)", 
    "en": "put on (shoes)"},
    {"kanji": "脱ぐ", "hiragana": "ぬぐ", "romaji": "nugu", "es": "quitarse (ropa)", 
    "en": "take off (clothes)"},
    ...
    {"kanji": "料理する", "hiragana": "りょうりする", "romaji": "ryouri suru", "es": "cocinar", 
    "en": "cook"},
    {"kanji": "旅行する", "hiragana": "りょこうする", "romaji": "ryokou suru", "es": "viajar", 
    "en": "travel"},
    {"kanji": "洗濯する", "hiragana": "せんたくする", "romaji": "sentaku suru", "es": "lavar ropa", 
    "en": "do laundry"},
    {"kanji": "質問する", "hiragana": "しつもんする", "romaji": "shitsumon suru", "es": "preguntar", 
    "en": "ask"},
